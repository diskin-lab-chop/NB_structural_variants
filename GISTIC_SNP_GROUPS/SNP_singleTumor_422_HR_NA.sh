...
export basedir=/mnt/isilon/maris_lab/target_nbl_ngs/Gonzalo/CNV_analysis/GISTIC_SNP_GROUPS/HR_NA
mkdir $basedir
echo --- running GISTIC ---
export segfile=/mnt/isilon/maris_lab/target_nbl_ngs/Gonzalo/CNV_analysis/GISTIC_SNP_GROUPS/SNP_singleTumor_422_HR_NA.seg
...
# echo 'sh SNP_singleTumor_422_HR_NA.seg' | qsub -cwd -pe smp 2 -l h_vmem=12G,m_mem_free=11G -N HR_NA
